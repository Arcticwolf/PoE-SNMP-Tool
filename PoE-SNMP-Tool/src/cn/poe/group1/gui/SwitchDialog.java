...
public class SwitchDialog extends JDialog {
    ...
    public SwitchDialog(Frame parent, boolean modal, Switch sw) {
        ...
        txtCommunity.setText(sw.getCommunity());
    ...
    private void initComponents() {
        ...
        jLabel6.getAccessibleContext().setAccessibleName("Community");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        try {
            if (updateMode) {
                ...
                sw.setCommunity(txtCommunity.getText());
            } else {
                sw = new Switch(txtIdentifier.getText(), txtIP.getText(), txtType.getText(), Integer.parseInt(txtPorts.getText()), txtComment.getText(), txtCommunity.getText());
            }
